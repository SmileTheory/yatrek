...
void GOSUB_L_3910()
{
	E = E - N - 10; if (E >= 0) return; cout << "SHIELD CONTROL SUPPLIES ENERGY TO COMPLETE THE MANEUVER." << endl;
...
int GOSUB_L_6000()
{
	if (K3 <= 0) return 0; if (D0 != 0) {
		cout << "STARBASE SHIELDS PROTECT THE ENTERPRISE" << endl; return 0;
	}
	for (I = 1; I <= 3; I++) {
		...
		if (S <= 0) return RGOTO_L_6240; cout << "      <SHIELDS DOWN TO" << " " << S << " " << "UNITS>" << endl; if (H < 20) goto L_6200; if (b_RND(1) > 0.6 || H / S <= 0.02) goto L_6200; R1 = b_FNR(1); D[(int)(R1)] = D[(int)(R1)] - H / S - 0.5 * b_RND(1); GOSUB_L_8790();
...
L_6650:
	...
	if (D[(int)(2)] >= 0) goto L_6770; cout << endl; cout << "*** SHORT RANGE SENSORS ARE OUT ***" << endl; cout << endl; return;
L_6770:
	s_O1 = "---------------------------------"; cout << s_O1 << endl; for (I = 1; I <= 8; I++) {
		;
		...
		;
L_6850:
		cout << "        STARDATE          " << " " << (int)(T * 10) * 0.1 << " " << endl; goto L_7260;
L_6900:
		cout << "        CONDITION          " << s_C << endl; goto L_7260;
L_6960:
		cout << "        QUADRANT          " << " " << Q1 << " " << "," << " " << Q2 << " " << endl; goto L_7260;
L_7020:
		cout << "        SECTOR            " << " " << S1 << " " << "," << " " << S2 << " " << endl; goto L_7260;
L_7070:
		cout << "        PHOTON TORPEDOES  " << " " << (int)(P) << " " << endl; goto L_7260;
L_7120:
		cout << "        TOTAL ENERGY      " << " " << (int)(E + S) << " " << endl; goto L_7260;
L_7180:
		cout << "        SHIELDS           " << " " << (int)(S) << " " << endl; goto L_7260;
L_7240:
		cout << "        KLINGONS REMAINING" << " " << (int)(K9) << " " << endl;
L_7260:
		;
	}
	; cout << s_O1 << endl; return;
}
...
L_1320:
	...
	if (Q1 < 1 || Q1 > 8 || Q2 < 1 || Q2 > 8) goto L_1600; GOSUB_L_9030(); cout << endl; if (T0 != T) goto L_1490; cout << "YOUR MISSION BEGINS WITH YOUR STARSHIP LOCATED" << endl;
	cout << "IN THE GALACTIC QUADRANT, '" << s_G2 << "'." << endl; goto L_1500;
L_1490:
	cout << "NOW ENTERING " << s_G2 << " QUADRANT . . ." << endl;
L_1500:
	cout << endl; K3 = (int)(G[(int)(Q1)][(int)(Q2)] * 0.01); B3 = (int)(G[(int)(Q1)][(int)(Q2)] * 0.1) - 10 * K3;
	S3 = G[(int)(Q1)][(int)(Q2)] - 100 * K3 - 10 * B3; if (K3 == 0) goto L_1590; cout << "COMBAT AREA      CONDITION RED" << endl; if (S > 200) goto L_1590; cout << "   SHIELDS DANGEROUSLY LOW" << endl;
L_1590:
	for (I = 1; I <= 3; I++) {
...
L_2300:
	cout << "COURSE (0-9)"; cout << "? "; cin >> C1;; if (C1 == 9) C1 = 1; if (C1 >= 1 && C1 < 9) goto L_2350; cout << "   LT. SULU REPORTS, 'INCORRECT COURSE DATA, SIR!'" << endl; goto L_1990;
L_2350:
...
L_2470:
	cout << "WARP ENGINES ARE DAMAGED.  MAXIUM SPEED = WARP 0.2" << endl; goto L_1990;
L_2490:
	N = (int)(W1 * 8 + 0.5); if (E - N >= 0) goto L_2590; cout << "ENGINEERING REPORTS   'INSUFFICIENT ENERGY AVAILABLE" << endl;
	cout << "                       FOR MANEUVERING AT WARP" << " " << W1 << " " << "!'" << endl;
	if (S < N - E || D[(int)(7)] < 0) goto L_1990; cout << "DEFLECTOR CONTROL ROOM ACKNOWLEDGES" << " " << S << " " << "UNITS OF ENERGY" << endl;
...
L_3500:
	...
	if (X5 == 0) goto L_3860; cout << "LT. UHURA REPORTS MESSAGE FROM STARFLEET COMMAND:" << endl;
...
L_4000:
	if (D[(int)(3)] < 0) {
		cout << "LONG RANGE SENSORS ARE INOPERABLE" << endl; goto L_1990;
	}
...
L_4230:
		...
		; cout << ":" << endl; cout << s_O1 << endl;;
	}
	; goto L_1990;
// PHASER CONTROL CODE BEGINS HERE
L_4260:
	if (D[(int)(4)] < 0) {
		cout << "PHASERS INOPERATIVE" << endl; goto L_1990;
	}
	if (K3 > 0) goto L_4330; L_4270:
	cout << "SCIENCE OFFICER SPOCK REPORTS  'SENSORS SHOW NO ENEMY SHIPS" << endl;
	cout << "                                IN THIS QUADRANT'" << endl; goto L_1990;
L_4330:
	if (D[(int)(8)] < 0) cout << "COMPUTER FAILURE HAMPERS ACCURACY" << endl; cout << "PHASERS LOCKED ON TARGET;  ";
L_4360:
	cout << "ENERGY AVAILABLE =" << " " << E << " " << "UNITS" << endl;
	cout << "NUMBER OF UNITS TO FIRE"; cout << "? "; cin >> X;; if (X <= 0) goto L_1990; if (E - X < 0) goto L_4360; E = E - X; if (D[(int)(7)] < 0) X = X * b_RND(1); H1 = (int)(X / K3); for (I = 1; I <= 3; I++) {
		if (K[(int)(I)][(int)(3)] <= 0) goto L_4670; H = (int)((H1 / b_FND(0)) * (b_RND(1) + 2)); if (H > 0.15 * K[(int)(I)][(int)(3)]) goto L_4530; cout << "SENSORS SHOW NO DAMAGE TO ENEMY AT " << " " << K[(int)(I)][(int)(1)] << " " << "," << " " << K[(int)(I)][(int)(2)] << " " << endl; goto L_4670;
L_4530:
		K[(int)(I)][(int)(3)] = K[(int)(I)][(int)(3)] - H; cout << " " << H << " " << "UNIT HIT ON KLINGON AT SECTOR" << " " << K[(int)(I)][(int)(1)] << " " << ",";
		cout << " " << K[(int)(I)][(int)(2)] << " " << endl; if (K[(int)(I)][(int)(3)] <= 0) {
			cout << "*** KLINGON DESTROYED ***" << endl; goto L_4580;
		}
...
L_4700:
	if (P <= 0) {
		cout << "ALL PHOTON TORPEDOES EXPENDED" << endl; goto L_1990;
	}
	if (D[(int)(5)] < 0) {
		cout << "PHOTON TUBES ARE NOT OPERATIONAL" << endl; goto L_1990;
	}
L_4760:
	cout << "PHOTON TORPEDO COURSE (1-9)"; cout << "? "; cin >> C1;; if (C1 == 9) C1 = 1; if (C1 >= 1 && C1 < 9) goto L_4850; cout << "ENSIGN CHEKOV REPORTS,  'INCORRECT COURSE DATA, SIR!'" << endl;
	goto L_1990;
L_4850:
...
L_4920:
	...
	if (X3 < 1 || X3 > 8 || Y3 < 1 || Y3 > 8) goto L_5490; cout << "               " << " " << X3 << " " << "," << " " << Y3 << " " << endl; s_A = "   "; Z1 = X; Z2 = Y; GOSUB_L_8830();
	if (Z3 != 0) goto L_4920; s_A = "+K+"; Z1 = X; Z2 = Y; GOSUB_L_8830(); if (Z3 == 0) goto L_5210; cout << "*** KLINGON DESTROYED ***" << endl; K3 = K3 - 1; K9 = K9 - 1; if (K9 <= 0) goto L_6370; for (I = 1; I <= 3; I++) {
...
L_5210:
	s_A = " * "; Z1 = X; Z2 = Y; GOSUB_L_8830(); if (Z3 == 0) goto L_5280; cout << "STAR AT" << " " << X3 << " " << "," << " " << Y3 << " " << "ABSORBED TORPEDO ENERGY." << endl; if (GOSUB_L_6000() == RGOTO_L_6240) goto L_6240; goto L_1990;
L_5280:
	s_A = ">!<"; Z1 = X; Z2 = Y; GOSUB_L_8830(); if (Z3 == 0) goto L_4760; cout << "*** STARBASE DESTROYED ***" << endl; B3 = B3 - 1; B9 = B9 - 1;
	if (B9 > 0 || K9 > T - T0 - T9) goto L_5400; cout << "THAT DOES IT, CAPTAIN!!  YOU ARE HEREBY RELIEVED OF COMMAND" << endl;
	cout << "AND SENTENCED TO 99 STARDATES AT HARD LABOR ON CYGNUS 12!!" << endl;
	goto L_6270;
L_5400:
	cout << "STARFLEET COMMAND REVIEWING YOUR RECORD TO CONSIDER" << endl;
...
L_5490:
	cout << "TORPEDO MISSED" << endl; if (GOSUB_L_6000() == RGOTO_L_6240) goto L_6240; goto L_1990;
// SHIELD CONTROL
L_5530:
	if (D[(int)(7)] < 0) {
		cout << "SHIELD CONTROL INOPERABLE" << endl; goto L_1990;
	}
	cout << "ENERGY AVAILABLE =" << " " << E + S << " "; cout << "NUMBER OF UNITS TO SHIELDS"; cout << "? "; cin >> X;;
	if (X < 0 || S == X) {
		cout << "<SHIELDS UNCHANGED>" << endl; goto L_1990;
	}
	if (X <= E + S) goto L_5630; cout << "SHIELD CONTROL REPORTS  'THIS IS NOT THE FEDERATION TREASURY.'" << endl;
	cout << "<SHIELDS UNCHANGED>" << endl; goto L_1990;
L_5630:
	E = E + S - X; S = X; cout << "DEFLECTOR CONTROL ROOM REPORT:" << endl;
	cout << "  'SHIELDS NOW AT" << " " << (int)(S) << " " << "UNITS PER YOUR COMMAND.'" << endl; goto L_1990;
// DAMAGE CONTROL
L_5690:
	if (D[(int)(6)] >= 0) goto L_5910; cout << "DAMAGE CONTROL REPORT NOT AVAILABLE" << endl; if (D0 == 0) goto L_1990; L_5720:
	D3 = 0; for (I = 1; I <= 8; I++) {
		if (D[(int)(I)] < 0) D3 = D3 + 0.1; ;
	}
	; if (D3 == 0) goto L_1990; cout << endl; D3 = D3 + D4; if (D3 >= 1) D3 = 0.9; cout << "TECHNICIANS STANDING BY TO EFFECT REPAIRS TO YOUR SHIP;" << endl;
	...
	; T = T + D3 + 0.1;
L_5910:
	cout << endl; cout << "DEVICE             STATE OF REPAIR" << endl; for (R1 = 1; R1 <= 8; R1++) {
		;
		GOSUB_L_8790(); cout << s_G2 << b_LEFT(s_Z, 25 - b_LEN(s_G2)) << " " << (int)(D[(int)(R1)] * 100) * 0.01 << " " << endl;
		;
	}
	; cout << endl; if (D0 != 0) goto L_5720; goto L_1990;

// END OF GAME
L_6220:
	cout << "IT IS STARDATE" << " " << T << " " << endl; goto L_6270;
L_6240:
	cout << endl; cout << "THE ENTERPRISE HAS BEEN DESTROYED.  THEN FEDERATION ";
	cout << "WILL BE CONQUERED" << endl; goto L_6220;
L_6270:
	cout << "THERE WERE" << " " << K9 << " " << "KLINGON BATTLE CRUISERS LEFT AT" << endl;
	cout << "THE END OF YOUR MISSION." << endl;
L_6290:
	cout << endl; cout << endl; if (B9 == 0) goto L_6360; cout << "THE FEDERATION IS IN NEED OF A NEW STARSHIP COMMANDER" << endl;
	...
	exit(0);
L_6370:
	cout << "CONGRULATION, CAPTAIN!  THEN LAST KLINGON BATTLE CRUISER" << endl;
...
L_7290:
	if (D[(int)(8)] < 0) {
		cout << "COMPUTER DISABLED" << endl; goto L_1990;
	}
L_7320:
	cout << "COMPUTER ACTIVE AND AWAITING COMMAND"; cout << "? "; cin >> A;; if (A < 0) goto L_1990; cout << endl; H8 = 1; if (A + 1 == 1) goto L_7540;
...
L_7400:
	H8 = 0; G5 = 1; cout << "                        THE GALAXY" << endl; goto L_7550;
// CUM GALACTIC RECORD
L_7540:
...
L_7850:
	...
	; cout << endl; goto L_1990;
// STATUS REPORT
L_7900:
	cout << "   STATUS REPORT:" << endl; s_X = ""; if (K9 > 1) s_X = "S"; cout << "KLINGON" << s_X << " LEFT: " << " " << K9 << " " << endl;
	...
	goto L_5690;
L_8010:
	cout << "YOUR STUPIDITY HAS LEFT YOU ON YOUR ON IN" << endl;
	cout << "  THE GALAXY -- YOU HAVE NO STARBASES LEFT!" << endl; goto L_5690;
// TORPEDO, BASE NAV, D/D CALCULATOR
L_8070:
	if (K3 <= 0) goto L_4270; s_X = ""; if (K3 > 1) s_X = "S"; cout << "FROM ENTERPRISE TO KLINGON BATTLE CRUSER" << s_X << endl;
	H8 = 0; for (I = 1; I <= 3; I++) {
...
L_8280:
		C1 = 1;
L_8290:
		if (abs(A) <= abs(X)) goto L_8330; cout << "DIRECTION =" << " " << C1 + (((abs(A) - abs(X)) + abs(A)) / abs(A)) << " " << endl; goto L_8460;
L_8330:
		cout << "DIRECTION =" << " " << C1 + (abs(A) / abs(X)) << " " << endl; goto L_8460;
L_8350:
		if (A > 0) {
			C1 = 3; goto L_8420;
		}
...
L_8410:
		C1 = 7;
L_8420:
		if (abs(A) >= abs(X)) goto L_8450; cout << "DIRECTION =" << " " << C1 + (((abs(X) - abs(A)) + abs(X)) / abs(X)) << " " << endl; goto L_8460;
L_8450:
		cout << "DIRECTION =" << " " << C1 + (abs(X) / abs(A)) << " " << endl;
L_8460:
		cout << "DISTANCE =" << " " << sqrt(X * X + A * A) << " " << endl; if (H8 == 1) goto L_1990; L_8480:
		;
	}
	; goto L_1990;
L_8500:
	if (B3 != 0) {
		cout << "FROM ENTERPRISE TO STARBASE:" << endl; W1 = B4; X = B5; goto L_8120;
	}
